...
class AM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.filter_fft_low_pass_filter_0_0 = filter.fft_filter_ccf(1, firdes.low_pass(1, samp_rate, 5000, 1000, window.WIN_HAMMING, 6.76), 1)
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(1, samp_rate, 5000, 500, window.WIN_HAMMING, 6.76), 1)
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 20, 1, 0, 0)
        self.analog_sig_source_x_0_1.set_block_alias("Source")
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, (-10000), 1, 0, 0)
        self.analog_sig_source_x_0_0_0_0.set_block_alias("Carrier")
        ...
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_divide_xx_0, 0))
        self.connect((self.blocks_divide_xx_0, 0), (self.filter_fft_low_pass_filter_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.filter_fft_low_pass_filter_0_0, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.blocks_multiply_xx_1, 0))
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.filter_fft_low_pass_filter_0_0, 0), (self.analog_am_demod_cf_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_1, 0), (self.audio_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 5000, 500, window.WIN_HAMMING, 6.76))
        self.filter_fft_low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 5000, 1000, window.WIN_HAMMING, 6.76))
